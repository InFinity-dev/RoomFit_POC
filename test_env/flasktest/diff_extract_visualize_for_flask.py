...
def clustering_peakSection(filtered_result, idxs):
    pose_data = filtered_result.T.to_numpy()[0][idxs]
...
def run(folder_name):
    ...
    for s_idx in range(1, len(section)):
        ...
        posing_section = clustering_peakSection(result_filtered_savgol, pose_idxs)
